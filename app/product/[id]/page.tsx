...
export default async function ProductDetailsPage({
  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="bg-[#0a0f1e]/80 backdrop-blur-xl rounded-3xl p-6 lg:p-12 border border-white/10 shadow-2xl relative overflow-hidden">
        {/* Glow Effects */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
          ...
          <div className="lg:col-span-5 relative rounded-3xl overflow-hidden bg-white/5 flex items-center justify-center border border-white/10 p-4">
            ...
            <span className="absolute top-6 left-6 px-4 py-1.5 bg-black/80 backdrop-blur-md rounded-full text-xs font-bold tracking-wider text-cyan-400 border border-cyan-500/30 uppercase shadow-lg">
              {product.category}
            </span>
          </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-8">
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-300 text-lg leading-relaxed bg-white/5 p-5 rounded-2xl border border-white/5">
                {product.description}
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="flex flex-col items-center justify-center p-4 rounded-2xl bg-white/5 border border-white/5 text-center">
              ...
              <div className="flex flex-col items-center justify-center p-4 rounded-2xl bg-white/5 border border-white/5 text-center">
                <Headphones className="w-6 h-6 text-cyan-400 mb-2" />
                <span className="text-xs text-slate-300 font-medium">
                  Premium Build
                </span>
              </div>
