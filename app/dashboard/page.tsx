...
const statusConfig: Record<string, { icon: LucideIcon; color: string; bg: string; border: string; label: string }> = {
  ...
  delivered: { icon: CheckCircle2, color: "text-green-400", bg: "bg-green-400/10", border: "border-green-400/30", label: "Delivered" },
};
                ...
                >
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-slate-500 text-xs mt-1">Order total</p>
                    </div>
                  </div>
                </div>
              );
